...
public class QLNhanVien extends javax.swing.JDialog {
    ...
    public boolean checkNull(){
        if(Hepler.checkNull(txtMaNV, "Mã nhân viên không được trống")) return false;
        if(Hepler.checkNull(txtPassword, "mật khẩu không được trống")) return false;
        if(Hepler.checkNull(txtConfirmPassword, "xác nhận lại mật khẩu không được trống")) return false;
        if(Hepler.checkNull(txtHoTen, "họ tên nhân viên không được trống")) return false;
        return true;
    }
